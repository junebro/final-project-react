...
import img1 from "./../images/두부콩류.png";
import img2 from "./../images/과일류.png";
import img3 from "./../images/유제품류.png";
...
const App = () => {
  const { drag1Items, setDrag1Items } = useContext(NutriContext);
    ...
    <DragDropContext onDragEnd={onDragEnd}>
      ...
      <div>
        {!validButton ? (
          <div>
            <Link
              to="http://localhost:3000/nutri/nutri/content09"
