...
import img1 from "./../images/생채소류.png";
import img2 from "./../images/채소반찬류.png";
import img3 from "./../images/김치절임류.png";
...
const App = () => {
  const { drag4Items, setDrag4Items } = useContext(NutriContext);
