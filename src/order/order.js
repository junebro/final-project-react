    ...
    <div style={{ backgroundColor: "white" }}>
      ...
      <form className="order-form">
        ...
        <div className="form-group">
          ...
          <div>
            <input
              className="order-test-text-test"
              placeholder="우편번호"
              value={inputBuyerAddress.zonecode}
            />
            <button
              type="button"
              id="post-btn"
              className="post-btn"
              onClick={openByerPostCode}
            >
              우편번호 찾기
            </button>
            {/* // 팝업 생성 기준 div */}
        ...
        <div className="order-adress">
          ...
          <div className="order-address-box">
            <div style={{ marginBottom: "10px" }}>
              <input
                id="road-name"
                className="order-adress-text"
                placeholder="도로명주소"
                value={inputBuyerAddress.address}
              />
            </div>
            <div style={{ marginBottom: "10px" }}>
              <input
        ...
        <div className="order-customer-radio">
          <input
            ...
            checked={isChecked}
          />
          <label className="order-customer-label" for="customer-select">
            주문자 정보와 동일
          </label>
        </div>
        ...
        <div className="form-group">
          ...
          <div>
            <input
              className="order-test-text-test"
              placeholder="우편번호"
              value={inputRecipientAddress.zonecode}
            />
            <button
              type="button"
              id="post-btn"
          ...
          <div className="order-address-box">
            <div style={{ marginBottom: "10px" }}>
              <input
                ...
                className="order-adress-text"
                placeholder="도로명주소"
                value={inputRecipientAddress.address}
              />
            </div>
            <div style={{ marginBottom: "10px" }}>
              <input
        ...
        <div className="form-payment-info">
          ...
          <div className="choice-button" onClick={() => handleClick(1)}>
            계좌 이체
          </div>
          <div className="choice-button" onClick={() => handleClick(2)}>
            신용/체크카드
          </div>
          <div className="choice-button" onClick={() => handleClick(3)}>
            무통장 입금
          </div>
        </div>

        {activeTextIndex === 1 && (
          <div style={paymentStyle}>Text for Button 01</div>
        )}
        {activeTextIndex === 2 && (
          <div style={paymentStyle}>Text for Button 02</div>
        )}
        {activeTextIndex === 3 && (
          <div style={paymentStyle}>Text for Button 03</div>
        )}
